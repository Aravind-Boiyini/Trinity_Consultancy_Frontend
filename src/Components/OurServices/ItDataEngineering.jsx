        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-700 text-[15px] leading-relaxed mb-6">
              At Gunesh Technologies, we provide end-to-end Data Engineering solutions to help businesses transform raw data into actionable insights. 
          ...
          <div>
            ...
            <div className="mb-5 flex gap-3">
              ...
              <div>
                ...
                <p className="text-gray-700 text-[15px] leading-relaxed">
                  At Gunesh Technologies, we turn data into a strategic asset, helping businesses gain a competitive edge through
